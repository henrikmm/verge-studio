...
export function defaultGraph(): { nodes: GraphNode[]; edges: GraphEdge[] } {
  return {
    ...
    edges: [
      ...
      { id: "e-points-ground", source: "point-cloud", sourcePort: "measurement", target: GROUND_PLANE_ID, targetPort: "points" },
      { id: "e-fixture-selection", source: FIXTURE_RUN_ID, sourcePort: "depth", target: BRUSH_SELECTION_ID, targetPort: "depth" },
      { id: "e-points-selection", source: "point-cloud", sourcePort: "measurement", target: BRUSH_SELECTION_ID, targetPort: "points" },
